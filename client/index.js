...
app.use(expressSession({
  ...
  cookie: { secure: false }, // use http (change to `true` if using https)
  maxAge: 1000 * 60 * 60 // 1h
}));

// Using locals to store Reader session data
...
// Error Handling Middleware (404 and development error handling)
app.use(notFound);
